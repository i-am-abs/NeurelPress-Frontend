                    ...
                    {books?.map((book) => (
                        ...
                        >
                            {book.coverUrl ? (
                                ...
                                <div
                                    className="flex h-16 w-12 items-center justify-center rounded bg-muted text-xs font-medium">
                                    Cover
                                </div>
                            )}
                            <div className="flex-1 min-w-0">
                                ...
                                {book.category && (
                                    <span
                                        className="mt-1 inline-block rounded bg-muted px-2 py-0.5 text-xs text-muted-foreground">
                    {book.category}
                  </span>
                                )}
                            </div>
