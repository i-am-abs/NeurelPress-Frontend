...
import { HiOutlinePencilSquare, HiOutlineMagnifyingGlass } from "react-icons/hi2";
      ...
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden items-center gap-4 md:flex">
            ...
            <Link href="/explore" className="text-sm text-muted-foreground transition hover:text-foreground">
              Explore
            </Link>
            <Link href="/library" className="text-sm text-muted-foreground transition hover:text-foreground">
              Library
            </Link>
          </div>
        </div>
